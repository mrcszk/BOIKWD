...
# Jesli wyskoczy taki blad
# FileNotFoundError: [Errno 2] No such file or directory: 'knapsack_problems\\ks_4_0'
# zmien folder na sciezke bezwzgledna!

class KnapsackBenchmark:

    def __init__(self, problems: List[str], timelimit: int = 60, solver_types: List[SolverType] = list(SolverType), print_function: Callable = print, problems_dir: str = "knapsack_problems"): # jesli nie dziala zmien sciezke na bezwgledna
